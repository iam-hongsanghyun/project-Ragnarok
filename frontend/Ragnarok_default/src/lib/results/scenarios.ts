...
export function defaultAssetSwapConfig(): AssetSwapConfig {
  return { enabled: false, removeFilters: [], addCarrier: '', addCapitalCost: 0, addMarginalCost: 0, replaceRatio: 1, sizeReplacement: false, addStorageMW: 0, addStorageHours: 4, addStorageCapexPerMW: 20000 };
}
