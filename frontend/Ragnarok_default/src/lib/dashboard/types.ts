...
export interface AdequacyCardData extends CardBase {
  kind: 'adequacy';
}
...
export interface CorrelatedSamplingCardData extends CardBase {
  kind: 'correlated-sampling';
}

export interface RampCardData extends CardBase {
  kind: 'ramp';
}
