...
export { API_BASE, MAX_UNPINNED_HISTORY, MODULES_CONFIG, RUN_POLLING, RUN_WINDOW, SETTINGS_CONFIG, SETTINGS_DEFAULTS, CURRENCIES, FORGE_CONFIG, VALIDATION_CONFIG } from './config';
